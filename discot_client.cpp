...
#include "discot/discot_client_runner.hpp"
...
int main(int argc, char** argv) {
    ...
    sse::logger::set_benchmark_file("benchmark_discot_client.out");
...
//            input_files.push_back("/Volumes/Storage/WP_Inverted/inverted_index_all_sizes/inverted_index_10000.json");
    ...
    std::unique_ptr<sse::discot::DiscotClientRunner> client_runner;
