...
//                new_entries += 3;
         ...
         static void disco_generation_job(unsigned int thread_id, size_t N_entries, size_t global_up_rnd_count, size_t step, crypto::Fpe *rnd_perm, std::atomic_size_t *entries_counter, std::atomic_size_t *docs_counter, std::function<void(const std::string &, size_t)> callback)
        {
            ...
            uint32_t counter_10_1 = 0, counter_20 = 0, counter_30 = 0, counter_60 = 0, counter_10_2 = 0, counter_10_3 = 0, counter_10_4 = 0, counter_10_5 = 0, counter_10_6 = 0;
            counter_10_1 = global_up_rnd_count / 10;
            counter_10_2 = global_up_rnd_count / 100;
            counter_10_3 = global_up_rnd_count / 1000;
            counter_10_4 = global_up_rnd_count / 10000;
            counter_10_5 = global_up_rnd_count / 100000;
            counter_10_6 = global_up_rnd_count / 1000000;
...
//            
            ...
            for (size_t i = global_up_rnd_count; counter < N_entries; counter += step, i++) {
                size_t ind = rnd_perm->encrypt_64(counter);
                new_entries = 0;
...
//                new_entries += 3;
        ...
        void disco_gen_db(size_t N_entries, size_t global_up_rnd_counter, std::function<void(const std::string &, size_t)> callback)
        {
            ...
            for (unsigned int i = 0; i < n_threads; i++) {
                threads.push_back(std::thread(disco_generation_job, i, N_entries, global_up_rnd_counter, n_threads, &rnd_perm, &entries_counter, &docs_counter, callback));
            }
