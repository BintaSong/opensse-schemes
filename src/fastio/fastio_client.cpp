...
FastioClient::FastioClient(const std::string &se_map_path, const std::string &up_map_path, const size_t tm_setup_size) : k_prf_(), s_prf_(), se_counter_map_(se_map_path), up_counter_map_(up_map_path)
{
}

FastioClient::FastioClient(const std::string &se_map_path, const std::string &up_map_path, const std::string &derivation_master_key, const std::string &state_master_key) : k_prf_(derivation_master_key), s_prf_(state_master_key), se_counter_map_(se_map_path), up_counter_map_(up_map_path)
{
}
