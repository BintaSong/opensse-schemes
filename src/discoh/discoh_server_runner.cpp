...
namespace sse
{
    namespace discoh
    {
        ...
        DiscohImpl::DiscohImpl(const std::string &path) : storage_path_(path), async_search_(true)
        {
        ...
        void DiscohImpl::flush_server_storage()
        {
            if (server_)
            {
