...
#include "discoh/discoh_server.hpp"
...
namespace discoh {
    ...
    public:
        ...
        grpc::Status search(grpc::ServerContext* context,
                            const discoh::SearchRequestMessage* request,
                            grpc::ServerWriter<discoh::SearchReply>* writer) override;
        ...
        grpc::Status update(grpc::ServerContext* context,
                            const discoh::UpdateRequestMessage* request,
                            google::protobuf::Empty* e) override;
        
        grpc::Status bulk_update(grpc::ServerContext* context,
                                 grpc::ServerReader<discoh::UpdateRequestMessage>* reader,
                                 google::protobuf::Empty* e) override;
    ...
    private:
        ...
        std::unique_ptr<DiscohServer> server_;
